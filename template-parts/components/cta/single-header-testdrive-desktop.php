        ...
        <div class="ca-flex ca-flex-col ca-items-center ca-justify-center ca-w-1/3">
            <a
                ...
                <?php echo $testdrive_display == "elementor" ? 'onClick="elementorProFrontend.modules.popup.showPopup( { id: ' . $testdrive_elementor . ' } );"' : ''; ?>
                    class="show-modal ca-no-underline ca-ml-2 ca-px-4 ca-bg-primary bg-primary ca-rounded ca-h-10 ca-flex ca-items-center ca-justify-center ca-text-white hover:ca-text-white hover:ca-no-underline <?php echo $testdrive_display == "default" ? 'show-modal' : ''; ?>"
