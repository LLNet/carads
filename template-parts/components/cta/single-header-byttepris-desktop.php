    ...
    if ($byttepris_display != "disabled") {
        ...
        <a
            ...
            <?php echo $byttepris_display == "elementor" ? 'onClick="elementorProFrontend.modules.popup.showPopup( { id: ' . $byttepris_elementor . ' } );"' : ''; ?>
                class="ca-bg-primary bg-primary ca-rounded ca-ml-2 ca-h-10 ca-px-4 ca-mb-2 ca-flex ca-items-center ca-justify-center ca-text-white hover:ca-text-white
                hover:ca-no-underline
...
echo apply_filters('car_ads_byttepris_btn', $byttepris_btn, $product);