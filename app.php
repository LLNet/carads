...
if (!class_exists('CarAdsApp')) {
    ...
    class CarAdsApp
    {
        ...
        public function __construct()
        {
            ...
            // Ajax functions
            add_action('wp_ajax_votebox_vote', [$this, 'votebox_vote']);
            add_action('wp_ajax_nopriv_votebox_vote', [$this, 'votebox_vote']);
        ...
        public function add_styles_and_scripts()
        {
            ...
            if(is_post_type_archive('bil')) {
                ...
                wp_enqueue_script('car-slider', "//cdnjs.cloudflare.com/ajax/libs/bootstrap-slider/11.0.2/bootstrap-slider.min.js", array('jquery'), '', true);
                wp_enqueue_script('car-multiselect', "//cdnjs.cloudflare.com/ajax/libs/bootstrap-multiselect/0.9.16/js/bootstrap-multiselect.min.js", array('jquery'), '', true);
